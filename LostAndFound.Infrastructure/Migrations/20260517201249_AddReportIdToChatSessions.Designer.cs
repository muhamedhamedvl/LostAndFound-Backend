...
namespace LostAndFound.Infrastructure.Migrations
{
    ...
    [Migration("20260517201249_AddReportIdToChatSessions")]
    partial class AddReportIdToChatSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LostAndFound.Domain.Entities.ChatSession", b =>
                {
                    ...
                    b.HasIndex("ReportId", "User1Id", "User2Id")
                        .IsUnique()
            ...
            modelBuilder.Entity("LostAndFound.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
